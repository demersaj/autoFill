function autoFillGoogleDoc(e) {
  ...
  for (let i = 0; i < equipment.length; i++) {
    body.appendListItem(equipment[i].name + ' (' + equipment[i].qty + ')').setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (smartStation) {
    ...
    paragraph.editAsText().setBold(0, 17, true);  // set first part to bold - there has to be a better way
    body.appendListItem(siteReqsNote1).setGlyphType(DocumentApp.GlyphType.BULLET);
    body.appendListItem(siteReqsNote2).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (typePOF == 'Free Standing') {
    ...
    body.appendParagraph(pofStand).setAttributes(bold);
    body.appendListItem(pofStandNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);

    copyAllFiles('1e9YSDTjubv3HJ4njmGo1-k_cvn8IvAPM', templateResponseFolder); // copy sell sheet
  } else if (typePOF == 'Wall Mounted') {
    console.log('POF: ' + typePOF);
    body.appendParagraph(pofWall).setAttributes(bold);
    body.appendListItem(pofWallNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
    body.appendListItem(pofWallNote2).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (laneTraffic) {
    ...
    body.appendParagraph(laneTrafficMain).setAttributes(bold);
    body.appendListItem(laneTrafficNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (avi) {
    ...
    body.appendParagraph(aviMain).setAttributes(bold);
    body.appendListItem(aviNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
    body.appendListItem(aviNote2).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (lpr) {
    ...
    body.appendParagraph(lprMain).setAttributes(bold);
    body.appendListItem(lprNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (securityCam == 'Yes') {
    ...
    body.appendParagraph(securityCamMain).setAttributes(bold);
    body.appendListItem(securityCamNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (longRange == 'Yes') {
    ...
    body.appendParagraph(longRangeMain).setAttributes(bold);
    body.appendListItem(longRangeNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (lotFull) {
    ...
    body.appendParagraph(lotFullMain).setAttributes(bold);
    body.appendListItem(lotFullNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  if (occupancy) {
    ...
    body.appendParagraph(occupancyMain).setAttributes(bold);
    body.appendListItem(occupancyNote1).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  // commend
  if (commend) {
    body.appendParagraph(commendMain).setAttributes(bold);
    body.appendListItem(commendNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  ...
  body.appendParagraph(mdfMain).setAttributes(bold);
  body.appendListItem(mdfNote1).setAttributes(style).setGlyphType(DocumentApp.GlyphType.BULLET);
  body.appendListItem(mdfNote2).setGlyphType(DocumentApp.GlyphType.BULLET);
  body.appendListItem(mdfNote3).setGlyphType(DocumentApp.GlyphType.BULLET);

  body.appendParagraph(comMain).setAttributes(bold);
  body.appendParagraph(comNote1).setAttributes(style);
  body.appendParagraph(comNote2).setIndentFirstLine(28);
  body.appendParagraph(comNote3).setIndentFirstLine(28);
